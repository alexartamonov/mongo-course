...
3. Увеличилось количество проверок ключей из за использования нескольких форм слова в нашей коллекции



# Вывод

В рамках данной работы произведенны работы коллекцией, добавлен индекс для поиска, проанализированы выводы Explain
